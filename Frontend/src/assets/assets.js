...
export const products = [
    ...
    {
        _id: "aaabk2", // Ensure a unique ID
        name: "Women cotton bra",
        description: "A soft, casual cotton  Bra  with a relaxed fit, perfect for everyday wear. Features a comfortable crew neckline and short sleeves.",
        price: 1.9,
        image: [p_img53], // Use p_img53 here
        category: "Women",
        subCategory: "Topwear",
        sizes: ["S", "M", "L", "XL"],
